...
rem shortcuts
set PRQ=c:/openjdkbuild/prerequisites
...
set ALT_FREETYPE_LIB_PATH=%PRQ%/libs/freetype/dist/6_32
...
set ALT_MSVCRT_DLL_PATH=%PRQ%/libs/msvcr/6_32
set ALT_MSVCR71_DLL_PATH=%PRQ%/libs/msvcr/6_32
