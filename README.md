...
OpenJDK 6 binaries were built from `unofficial` branch of the [fork of OpenJDK 6 repositories forest](https://bitbucket.org/alexkasko/openjdk-jdk6-master).

OpenJDK 7 binaries were built from the `tip` of [official OpenJDK 7 Update 60 repositories forest](http://hg.openjdk.java.net/jdk7u/jdk7u60/).
