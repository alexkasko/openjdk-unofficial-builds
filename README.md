...
OpenJDK 6 binaries were built from [openjdk-6-src-b29-05_dec_2013.tar.gz](https://java.net/projects/openjdk6/downloads/download/openjdk-6-src-b29-05_dec_2013.tar.gz) sources (direct link) with this [patch for unlimited cryptography](http://icedtea.classpath.org/hg/icedtea6/file/73058db81e91/patches/clean-crypto.patch) (recommended by OpenJDK maintainers - [maillist thread](http://mail.openjdk.java.net/pipermail/jdk6-dev/2013-October/003087.html)) and [additional patch for windows](http://cr.openjdk.java.net/~akasko/jdk6/webrev_remove_sa_edit_and_continue.00/make/windows/makefiles/sa.make.udiff.html), [maillist thread](http://mail.openjdk.java.net/pipermail/jdk6-dev/2013-December/003163.html).
